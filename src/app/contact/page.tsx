...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with the CastZone team — general enquiries, advertising, moderation and technical support.",
...
export default function ContactPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      <h1 className="text-5xl font-heading font-semibold text-bone-white mb-2">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
        {[
          ...
          <div key={item.title} className="bg-deep-water-light border border-surface-teal rounded-lg p-6">
            <h2 className="text-bone-white font-heading font-semibold mb-1">{item.title}</h2>
      ...
      <div className="bg-deep-water-light border border-surface-teal rounded-lg p-6">
        <h2 className="text-bone-white font-heading font-semibold mb-3">Based in South Africa</h2>
