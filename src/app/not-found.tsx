  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-6xl font-heading font-bold text-cast-orange uppercase mb-2">404</h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <Link
            href="/forum"
            className="border border-surface-teal text-pale-water hover:text-bone-white font-heading font-bold uppercase tracking-wider px-6 py-3 rounded transition-colors"
          >
            Go to Forum
          </Link>
        </div>
