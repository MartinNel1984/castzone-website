...
export const KZN_DAMS: DamLevel[] = [
  ...
  { name: "Goedertrouw Dam",   river: "Mhlatuze River",    fsc:  301.3, pct:  97.3, lastWeek:  97.6, lastYear: 100.4, province: "KwaZulu-Natal", venueSlug: "goedertrouw-dam" },
  { name: "Hazelmere Dam",     river: "Mdloti River",      fsc:   37.2, pct:  95.5, lastWeek:  96.3, lastYear: 102.2, province: "KwaZulu-Natal", venueSlug: "hazelmere-dam" },
  ...
  { name: "Ntshingwayo Dam",   river: "Ngagane River",     fsc:  194.6, pct:  74.2, lastWeek:  74.7, lastYear:  95.1, province: "KwaZulu-Natal", venueSlug: "ntshingwayo-dam" },
  { name: "Pongolapoort Dam",  river: "Phongolo River",    fsc: 2395.3, pct:  85.6, lastWeek:  85.8, lastYear:  95.1, province: "KwaZulu-Natal", venueSlug: "pongolapoort-dam" },
  { name: "Spioenkop Dam",     river: "Tugela River",      fsc:  270.7, pct: 100.0, lastWeek: 100.0, lastYear: 100.3, province: "KwaZulu-Natal", venueSlug: "spioenkop-dam" },
  { name: "Spring Grove Dam",  river: "Mooi River",        fsc:  139.3, pct:  97.5, lastWeek:  99.0, lastYear: 100.4, province: "KwaZulu-Natal" },
  { name: "Wagendrift Dam",    river: "Boesmans River",    fsc:   55.9, pct: 100.2, lastWeek: 100.5, lastYear: 100.9, province: "KwaZulu-Natal", venueSlug: "wagendrift-dam" },
  { name: "Woodstock Dam",     river: "Tugela River",      fsc:  355.5, pct:  93.5, lastWeek:  94.9, lastYear:  97.7, province: "KwaZulu-Natal", venueSlug: "woodstock-dam" },
...
export const LP_DAMS: DamLevel[] = [
  { name: "Albasini Dam",        river: "Luvuvhu River",                   fsc:  28.2, pct:  94.7, lastWeek:  93.9, lastYear:  99.3, province: "Limpopo", venueSlug: "albasini-dam" },
  ...
  { name: "Flag Boshielo Dam",   river: "Olifants River",                  fsc: 185.2, pct: 102.8, lastWeek: 103.2, lastYear: 102.8, province: "Limpopo", venueSlug: "flag-boshielo-dam" },
  ...
  { name: "Nzhelele Dam",        river: "Nzhelele River",                  fsc:  51.3, pct: 101.5, lastWeek: 101.6, lastYear:  98.9, province: "Limpopo", venueSlug: "nzhelele-dam" },
...
export const MP_DAMS: DamLevel[] = [
  { name: "Blyderivierpoort Dam", river: "Blyde River",          fsc:  54.4, pct: 100.9, lastWeek: 101.0, lastYear: 100.3, province: "Mpumalanga", venueSlug: "blyderivierpoort-dam" },
  ...
  { name: "Heyshope Dam",         river: "Assegaai River",        fsc: 445.0, pct: 101.2, lastWeek: 101.4, lastYear: 100.2, province: "Mpumalanga", venueSlug: "heyshope-dam" },
  ...
  { name: "Kwena Dam",            river: "Krokodil River",        fsc: 158.7, pct: 100.7, lastWeek: 100.8, lastYear: 100.6, province: "Mpumalanga", venueSlug: "kwena-dam" },
...
export const NW_DAMS: DamLevel[] = [
  { name: "Boskop Dam",           river: "Mooi River",          fsc:  20.0, pct: 103.2, lastWeek: 103.8, lastYear: 102.6, province: "North West", venueSlug: "boskop-dam" },
  ...
  { name: "Molatedi Dam",         river: "Groot-Marico River",  fsc: 200.8, pct: 110.3, lastWeek: 111.3, lastYear: 108.5, province: "North West", venueSlug: "molatedi-dam" },
  ...
  { name: "Taung Dam",            river: "Harts River",         fsc:  61.4, pct: 100.7, lastWeek:  99.8, lastYear:  96.7, province: "North West", venueSlug: "taung-dam" },
...
export const EC_DAMS: DamLevel[] = [
  ...
  { name: "Darlington Dam",       river: "Sondags River",             fsc: 179.9, pct:  50.7, lastWeek:  52.5, lastYear:  47.6, province: "Eastern Cape", venueSlug: "darlington-dam" },
  ...
  { name: "Impofu Dam",           river: "Krom River",                fsc: 105.8, pct: 100.6, lastWeek: 100.9, lastYear:  52.1, province: "Eastern Cape", venueSlug: "impofu-dam" },
  ...
  { name: "Kouga Dam",            river: "Kouga River",               fsc: 126.0, pct: 101.1, lastWeek: 101.5, lastYear:  78.4, province: "Eastern Cape", venueSlug: "kouga-dam" },
  ...
  { name: "Ncora Dam",            river: "Tsomo River",               fsc: 144.9, pct:  97.3, lastWeek:  97.4, lastYear: 100.2, province: "Eastern Cape", venueSlug: "ncora-dam" },
  ...
  { name: "Umtata Dam",           river: "Mtata River",               fsc: 244.7, pct:  98.6, lastWeek:  98.7, lastYear: 101.5, province: "Eastern Cape", venueSlug: "umtata-dam" },
  { name: "Waterdown Dam",        river: "Klipplaat River",           fsc:  37.5, pct: 100.0, lastWeek:  99.9, lastYear: 100.3, province: "Eastern Cape" },
  { name: "Wriggleswade Dam",     river: "Kubisi River",              fsc:  91.5, pct:  95.7, lastWeek:  95.8, lastYear: 100.5, province: "Eastern Cape", venueSlug: "wriggleswade-dam" },
...
export const NC_DAMS: DamLevel[] = [
  ...
  { name: "Spitskop Dam",       river: "Harts River",  fsc:  57.9, pct: 107.6, lastWeek: 110.3, lastYear: 106.0, province: "Northern Cape", venueSlug: "spitskop-dam" },
  { name: "Vaalharts Weir Dam", river: "Vaal River",   fsc:  50.7, pct:  83.7, lastWeek:  57.4, lastYear:  57.5, province: "Northern Cape", venueSlug: "vaalharts-weir" },
];
